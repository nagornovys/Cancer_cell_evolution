...
# The example from paper:
# "A Guide to General-Purpose Approximate Bayesian Computation Software"
# by Athanasios Kousathanas, Pablo Duchen & Daniel Wegmann
# arxive:1806.083220v1



# Experimental data for different patients
...
######### Parameters and simulation data from files for 10 000 trials
...
# hist(rejection$unadj.values[,p], col = "red", main = NULL, xlab = nm_param, ylab = NULL)
