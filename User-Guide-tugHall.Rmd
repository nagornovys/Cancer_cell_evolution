...
4. To obtain analytic reports of the simulation, please refer to **User-Guide-Analysis.RMD**. 
In **User-Guide-Analysis.RMD**, commands are embeded to include files under **Output/** and **Figure/**. So, after analysis with tugHall, you can generate an analytic report automatically from **User-Guide-Analysis.RMD**. For more details, please refer to "Writing reproducible reports in R" on the github (https://nicercode.github.io/guides/reports/).
